      ...
      <table>
        ...
        <tbody>
          <tr v-for="(robot, index) in cart" :key="index">
            <!--Never use v-if and v-for on the same element for performance reasons -->
...
export default {
  ...
  data() {
    return {
      selectedRobot: {
        head: {}, leftArm: {}, torso: {}, rightArm: {}, base: {},
      },
      availableParts,
      cart: [],
    };
  ...
  methods: {
    addToCart() {
      ...
      const cost = robot.head.cost
        ...
        + robot.rightArm.cost
        + robot.base.cost;
      this.cart.push(Object.assign({}, robot, { cost })); // This is important.
    },
  },
};
</script>
